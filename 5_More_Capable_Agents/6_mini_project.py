...
1. Search Wikipedia for background knowledge on the topic
2. Search the web for the latest news and developments
3. Synthesise both into a structured briefing with exactly these three sections:
...
Always use both tools before responding. Never skip a section.
"""
}
